...
const Admin = () => {
  ...
  const fetchRestaurants = async() =>{
    await axios.get('http://localhost:3000/fetch-restaurants').then(
      (response)=>{
  ...
  const fetchOrders = async() =>{
    await axios.get('http://localhost:3000/fetch-orders').then(
      (response)=>{
  ...
  const approveUser = async(id) =>{
    await axios.post('http://localhost:3000/approve-user', {id}).then(
      (response)=>{
  ...
  const rejectUser = async(id) =>{
    await axios.post('http://localhost:3000/reject-user', {id}).then(
      (response)=>{
  ...
  const handlePromoteUpdate = async() =>{
    await axios.post('http://localhost:3000/update-promote-list', {promoteList}).then(
      (response) =>{
  ...
  const fetchPromotions = async () =>{
    await axios.get('http://localhost:3000/fetch-promoted-list').then(
      (response)=>{
